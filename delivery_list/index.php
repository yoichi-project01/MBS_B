    ...
    <div class="container">
        <div class="top-section">
            <div class="title-search">
                ...
                <div class="search-bar">
                    <input type="text" placeholder="顧客名（企業名含む）で検索" name="search" id="search_input"
        ...
        <table class="delivery-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><a
                            href="delivery_detail.php?delivery_no=<?= htmlspecialchars($delivery['delivery_no']) ?>"><?= htmlspecialchars($delivery['delivery_no']) ?></a>
                    </td>
                    <td><?= formatCustomerName($delivery['customer_name'], $delivery['store_name']) ?></td>
                    <td><span
                            class="status-button <?= htmlspecialchars($status['color']) ?>"><?= htmlspecialchars($status['text']) ?></span>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
        ...
        <div class="pagination">
            ...
            <button onclick="goToPage(<?= $current_page + 1 ?>)"
                <?= $current_page >= $total_pages ? 'disabled' : '' ?>>次</button>
        </div>
    </div>
