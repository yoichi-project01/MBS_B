...
<body class="with-header">
    ...
    <div class="container">
        <!-- 戻るボタン -->
        <button class="back-button-top" onclick="history.back()">
            <span>
        ...
        <div class="upload-container">
            ...
            <div class="help-section">
                <h4><i class="fas fa-info-circle"></i> CSVファイルの形式について</h4>
                <div class="help-content">
                    <p>以下の形式でCSVファイルを作成してください：</p>
                    <div class="csv-format">
                        <code>顧客名,メールアドレス,電話番号,住所</code>
                    </div>
                    <ul class="format-notes">
                        <li>1行目はヘッダー行として認識されます</li>
                        <li>文字エンコーディングはUTF-8を推奨します</li>
                        <li>最大ファイルサイズ: 5MB</li>
                    </ul>
                </div>
            </div>
